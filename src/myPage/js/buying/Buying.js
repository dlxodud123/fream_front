...
<Header />
    <div className="container_box">
        ...
        <div className="box-container">
            ...
            <div>
                {isModalTenderOpen && <ModalTender onClose={closeModalTender} buyBreakdown={dummyData} />}
                {isModalProgresOpen && <ModalProgres onClose={closeModalProgres} buyBreakdown={dummyData}/>}
                {isModalDealEndOpen && <ModalDealEnd onClose={closeModalDealEnd} buyBreakdown={dummyData}/>}
            </div>
        </div>
    </div>
    <Footer />
