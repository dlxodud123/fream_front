...
function Detail_buy_history_header(){
    ...
    return(
        <>
            <div className="header_contianer">
                ...
                <div style={{width:"450px", fontWeight:"bold", fontSize:"25px", textAlign:"right"}}>구매 내역</div>
                <div>
...
export default Detail_buy_history_header;
