            ...
            <div className="detail_info">
                ...
                <div className='add_benefit'>
                    ...
                    <div style={{display:"flex", fontSize:"13px", marginTop:"16px"}}>
                        <div style={{fontWeight:'lighter', color:"rgba(0,0,0,0.5)", width:"70px", textAlign:"left"}}>포인트</div>
                        <div style={{fontWeight:"bold"}}>계좌 간편결제 시 1% 적립</div>
                    </div>
                    <div style={{display:"flex", fontSize:"13px", marginTop:"10px"}}>
                        <div style={{fontWeight:'lighter', color:"rgba(0,0,0,0.5)", width:"70px", textAlign:"left"}}>결제</div>
                        <div style={{fontWeight:"bold"}}>계좌간편결제 최대 5만 포인트 적립 & 수수료 할인</div>
                    </div>
                </div>
                <div style={{width:"560px", height:"1px", backgroundColor:"rgba(0,0,0,0.1)"}}></div>
                ...
                <div className='ship_info'>
                    ...
                    <div style={{display:"flex", marginTop:"16px"}}>
                        ...
                        <div style={{textAlign:"left", fontSize:"13px", marginLeft:"20px", marginTop:"3px"}}>
                            <div style={{fontWeight:"bold"}}>빠른배송 5,000원</div>
                            <div style={{marginTop:"5px", color:"rgba(0,0,0,0.5)"}}>지금 결제 시 2일 뒤 도착 예정</div>
                        </div>
                    </div>
                    <div style={{display:"flex", marginTop:"16px"}}>
                        <div>
                        ...
                        <div style={{textAlign:"left", fontSize:"13px", marginLeft:"15px", marginTop:"3px"}}>
                            <div style={{fontWeight:"bold"}}>일반배송 3,000원</div>
                            <div style={{marginTop:"5px", color:"rgba(0,0,0,0.5)"}}>검수 후 배송 ・ 5-7일 내 도착 예정</div>
                        </div>
                    </div>
                    <div style={{display:"flex", marginTop:"16px"}}>
                        <div>
                        ...
                        <div style={{textAlign:"left", fontSize:"13px", marginLeft:"15px", marginTop:"3px"}}>
                            ...
                            <div style={{marginTop:"5px", color:"rgba(0,0,0,0.5)"}}>배송 없이 창고에 보관 ・ 빠르게 판매 가능</div>
                        </div>
                    </div>
                </div>
                ...
                <div className='guarantee'>
                    <div style={{display:"flex", marginTop:"16px"}}>
                        ...
                        <div style={{textAlign:"left", fontSize:"13px", marginLeft:"20px", marginTop:"3px"}}>
                            ...
                            <div style={{marginTop:"5px", color:"rgba(0,0,0,0.5)", fontSize:"12px"}}>KREAM에서 검수한 상품이 정품이 아닐 경우, 구매가의 3배를 보상합니다.</div>
                        </div>
                    </div>
                    <div style={{display:"flex", marginTop:"16px"}}>
                        <div>
                            <img src={guar_img1} style={{width:"45px", marginTop:"7px"}}></img>
                        </div>
                        <div style={{textAlign:"left", fontSize:"13px", marginLeft:"20px", marginTop:"3px"}}>
                            <div style={{fontWeight:"bold"}}>엄격한 다중 검수</div>
                            <div style={{marginTop:"5px", color:"rgba(0,0,0,0.5)", fontSize:"12px"}}>모든 상품은 검수센터에 도착한 후, 상품별 전문가 그룹의 체계적인 시스템을 거쳐 검수를 진행합니다.</div>
                        </div>
                    </div>
                    <div style={{display:"flex", marginTop:"16px"}}>
                        <div>
                        ...
                        <div style={{textAlign:"left", fontSize:"13px", marginLeft:"20px", marginTop:"3px"}}>
                            ...
                            <div style={{marginTop:"5px", color:"rgba(0,0,0,0.5)", fontSize:"12px"}}>검수에 합격한 경우에 한하여 KREAM의 정품 인증 패키지가 포함된 상품이 배송됩니다.</div>
                        </div>
                    </div>
                </div>
            </div>
