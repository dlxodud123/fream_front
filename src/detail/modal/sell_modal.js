...
const Sell_modal = (props) => {
    ...
    return(
        <>  
            <button onClick={() => setSellModal(true)} style={{width:"275px", height:"60px", display:"flex", color:"white", backgroundColor:"rgb(65, 185, 121)", borderRadius:"10px", fontWeight:"bold", marginLeft:"10px", border:"none"}}>
